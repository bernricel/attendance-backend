...
GOOGLE_MOBILE_CLIENT_ID = _get_env("GOOGLE_MOBILE_CLIENT_ID", "")
GOOGLE_DESKTOP_CLIENT_ID = _get_env("GOOGLE_DESKTOP_CLIENT_ID", "")
_google_oauth_client_ids = [
    GOOGLE_OAUTH_CLIENT_ID,
    GOOGLE_MOBILE_CLIENT_ID,
    GOOGLE_DESKTOP_CLIENT_ID,
    *_get_list_env("GOOGLE_OAUTH_CLIENT_IDS", ""),
]
GOOGLE_OAUTH_CLIENT_IDS = list(dict.fromkeys(item for item in _google_oauth_client_ids if item))
