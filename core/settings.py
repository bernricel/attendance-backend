...
SECRET_KEY = 'django-insecure-my5=wb2$!lh%z(y4^)6sjlhee#70$l%&#9snk$hunwnoy3c8+x'
...
DSA_PRIVATE_KEY_PATH = os.environ.get(
    ...
    str(BASE_DIR / 'secure_keys' / 'attendance_dsa_private.pem'),
)
DSA_PUBLIC_KEY_PATH = os.environ.get(
    'DSA_PUBLIC_KEY_PATH',
    str(BASE_DIR / 'secure_keys' / 'attendance_dsa_public.pem'),
)
